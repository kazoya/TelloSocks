...
export const siteConfig = {
  nameAr: "تيلو للجوارب",
  nameEn: "Tello / Mashreq Socks",
  brandLine: "TELLO",
  productName: "تصور مبيعات جوارب عائلية",
  parentAr: "مصنع المشرق للجوارب",
  parentEn: "Tello / Mashreq Socks",
  recipient: "مدير المبيعات",
  recipientRole: "تيلو للجوارب",
  country: "الأردن",
  city: "عمّان",
  cityDetailAr: "الأردن",
  since: 0,
  websiteUrl: "https://tellosocks.com/",
  defaultMapsUrl: "",
  defaultWhatsAppPhone: "962795025010",
  defaultWhatsAppPrefill: "السلام عليكم تيلو للجوارب بخصوص ",
  defaultEmails: ["mzhar@tellosocks.com"] as const,
  phones: ["962795025010", "962799521400"] as const,
  salesPhone: "962795025010",
