...
const items = [
  { title: "جملة الإغلاق", text: "صاحب المحل يريد تشكيلة عائلة لا زوجاً واحداً. المنصة تعدّ الكرتون وأنت تعتمد" },
  { title: "ما يدرَّب عليه المندوب", text: "يعيد الوعد كما هو: طلب تاجر تجزئة حسب المقاس واللون — السعر باعتمادك ثم يحول الرسالة بطاقة." },
